...
const UserDashboard = () => {
    ...
    return (
        <Container maxWidth="md" sx={{ mt: 4, backgroundColor: '#f4f9ff', borderRadius: 4, p: 4, boxShadow: 10 }}>
            <Typography variant="h4" fontWeight="bold" gutterBottom sx={{ color: '#003366', textAlign: 'center' }}>
                User Dashboard
            </Typography>
            <Typography variant="body1" gutterBottom sx={{ color: '#00509e', textAlign: 'center', mb: 3 }}>
                View your loan applications and download slips.
            </Typography>

            {/* Loan Calculator Section */}
            <Box sx={{ mt: 4, bgcolor: 'white', p: 4, borderRadius: 2, boxShadow: 10 }}>
                <Typography variant="h6" fontWeight="bold" color="primary" gutterBottom textAlign="center">
                    Loan Calculator
                </Typography>
            ...
            {loading ? (
                    ...
                    <Table>
                        <TableHead>
                            <TableRow sx={{ backgroundColor: '#f0f4ff' }}>
                                <TableCell sx={{ fontWeight: 'bold', color: '#003366' }}>Token Number</TableCell>
                                <TableCell sx={{ fontWeight: 'bold', color: '#003366' }}>Loan Category</TableCell>
                                <TableCell sx={{ fontWeight: 'bold', color: '#003366' }}>Loan Amount</TableCell>
                                <TableCell sx={{ fontWeight: 'bold', color: '#003366' }}>Status</TableCell>
                                <TableCell sx={{ fontWeight: 'bold', color: '#003366' }}>Action</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                                    ...
                                    <TableCell>
                                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                            <Button
                                                variant="contained"
                                                color="primary"
                                                onClick={() => handleSlipDownload(application.tokenNumber)}
                                                sx={{
                ...
                <>
                    <Typography variant="body1" sx={{ textAlign: 'center', color: '#00509e' }}>
