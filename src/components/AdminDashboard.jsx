...
import { Table, Button, Modal, TextField, Typography, Box, Paper, AppBar, Toolbar, TableContainer, TableHead, TableBody, TableRow, TableCell } from '@mui/material';
...
const AdminDashboard = () => {
  ...
  return (
    ...
    >
      <AppBar
        position="static"
        sx={{ background: 'linear-gradient(135deg, #1e88e5, #1976d2)', marginBottom: 3 }}
      >
        <Toolbar>
      ...
      >
        <Typography
          ...
          gutterBottom
          align="center"
          sx={{ background: 'linear-gradient(135deg, #1976d2, #4fc3f7)', color: 'white', padding: 2, borderRadius: 1 }}
        >
            ...
            <TableBody>
              {applications.map((application) => (
                <TableRow key={application._id}>
                  <TableCell>{application.tokenNumber || 'Not assigned'}</TableCell>
